...
angular.module('wpZestApp')
	.directive('cmHeader', ['$route', '$rootElement', '$rootScope', '$timeout', 'cmTransition', 'cmMqState', 'cmUtil',
		function($route, $rootElement, $rootScope, $timeout, cmTransition, cmMqState, cmUtil) {
			return {
				scope: {},
	...
	.directive('cmHeaderToggle', function() {
		return {
			scope: {},
